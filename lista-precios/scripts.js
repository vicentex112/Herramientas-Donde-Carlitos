const products = [
    ...
    { name: "Plátano", price: "$1300 kilo" },
    { name: "Uva", price: "$2500 kilo" },
    { name: "Morrón rojo", price: "$800 c/u" },
    { name: "Morrón verde", price: "$500 c/u" },
    { name: "Morrón amarillo", price: "$800 c/u" },
    { name: "Ajos", price: "$250 c/u" },
    { name: "Tomate cherry", price: "$4000 kg" },
    { name: "Limón", price: "$1200 kilo" },
    { name: "Poroto verde", price: "$2800 kilo" },
    { name: "Poroto granado", price: "$2200 kilo" },
    { name: "Ají verde", price: "$300 c/u" },
    { name: "Zanahoria", price: "$800 kilo" },
    { name: "Cebolla café", price: "$800 kilo" },
    { name: "Cebolla morada", price: "$1000 kilo" },
    { name: "Cebollín pelado", price: "$800 kilo" },
    ...
    { name: "Tomate grande común", price: "$1200 kilo" },
    { name: "Albahaca", price: "$1300 c/u" },
    { name: "Sandías", price: "$3000 c/u" },
    { name: "Melón tuna", price: "$2000 c/u" },
    { name: "Melón calameño", price: "$2200 c/u" },
    { name: "Naranjas", price: "$1000 kilo" },
    { name: "Mandarinas", price: "$1000 kilo" },
    { name: "Durazno", price: "$2000 kilo" },
    { name: "Brócoli", price: "$1300 c/u" },
    ...
    { name: "Poroto granado blanco", price: "$2000 c/u" },
